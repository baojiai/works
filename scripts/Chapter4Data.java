...
public class Chapter4Data {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Connection c = DriverManager.getConnection(URL, USER, PASSWORD)) {
            ...
            try {
                ...
                long customer = user(c, "chapter4_customer", "张女士", "13900004001", "CUSTOMER");
                long eng1 = user(c, "chapter4_engineer", "李明工程师", "13900004011", "ENGINEER");
                long eng2 = user(c, "chapter4_engineer2", "王强工程师", "13900004012", "ENGINEER");
                long eng3 = user(c, "chapter4_engineer3", "陈晨工程师", "13900004013", "ENGINEER");
                long applicant = user(c, "chapter4_applicant", "赵工", "13900004021", "CUSTOMER");
                ...
                long pendingPr = partRequest(c, "PR-CH4-PENDING", repairingOrder, eng1, "检测确认电源模块损坏且散热风扇异响，申请更换配件", "PENDING", null, null);
                ...
                c.commit();
                System.out.println("CHAPTER4_DATA_READY customer=chapter4_customer engineer=chapter4_engineer candidateRequest=" + candidateReq + " repairingOrder=" + repairingOrder + " acceptOrder=" + acceptOrder);
            } catch (Exception e) {
                c.rollback();
                throw e;
            }
    ...
    private static long user(Connection c, String username, String name, String phone, String role) throws Exception {
        up(c, "INSERT INTO system_user(username,password_hash,display_name,phone,role_type,status) VALUES(?,?,?,?,?,'ACTIVE') ON DUPLICATE KEY UPDATE password_hash=VALUES(password_hash),display_name=VALUES(display_name),phone=VALUES(phone),role_type=VALUES(role_type),status='ACTIVE'", username, HASH, name, phone, role);
        return id(c, "SELECT user_id FROM system_user WHERE username=?", username);
    }
