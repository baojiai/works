...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/app.css?v=4">
</head>
<body class="login-page edition-${edition}">
    <section class="login-visual">
        <div class="login-art">
            ...
            <div class="edition-grid">
                <a class="${edition == 'client' ? 'active' : ''}" href="${pageContext.request.contextPath}/client/login"><b>客户版</b><span>手机号注册、报修预约、工程师认证申请</span></a>
            ...
            <div class="workflow-preview">
                <div class="flow-item done"><b>01</b><span><strong>用户进入对应版本</strong><small>不同入口隔离业务身份</small></span></div>
                <div class="flow-line"></div>
                <div class="flow-item active"><b>02</b><span><strong>处理当前角色事项</strong><small>只展示该版本需要的功能</small></span></div>
                <div class="flow-line muted-line"></div>
                <div class="flow-item"><b>03</b><span><strong>形成服务闭环</strong><small>通知与日志可追溯</small></span></div>
            </div>
        </div>
    </section>
    ...
    <script src="${pageContext.request.contextPath}/assets/app.js?v=4"></script>
</body>
</html>
